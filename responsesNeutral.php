...
if($count==0){
	...
	$sqlStr3 = "UPDATE im3080_responses SET neutral = neutral + 1 WHERE ID_num = '$ID_num'";
	$result3=mysqli_query($link, $sqlStr3);
}
//If person has responded but want to change his response from "satisfied"/"unsatisfied" to "neutral"
//Also caters to if person accidentally click "neutral" twice
else if ($count == 1){
	$sqlStr4 = "UPDATE im3080_responses SET satisfied = 0 WHERE ID_num = '$ID_num'";
	$result4=mysqli_query($link, $sqlStr4);
	$sqlStr5 = "UPDATE im3080_responses SET unsatisfied = 0 WHERE ID_num = '$ID_num'";
	$result5=mysqli_query($link, $sqlStr5);
	$sqlStr6 = "UPDATE im3080_responses SET neutral = 0 WHERE ID_num = '$ID_num'";
	$result6=mysqli_query($link, $sqlStr6);
	$sqlStr7 = "UPDATE im3080_responses SET neutral = neutral + 1 WHERE ID_num = '$ID_num'";
